		...
		<SheetPortal>
			...
			<SheetPrimitive.Content
				...
				<SheetPrimitive.Close className="absolute right-8 top-8 transition-opacity outline-none">
					<IoMdClose className="text-3xl text-heading hover:text-primary transition-colors" />
...
const SheetHeader = ({ className, ...props }: { className: string }) => (
	<div
		className={cn(
...
const SheetFooter = ({ className, ...props }: { className: string }) => (
	<div
		className={cn(
...
const SheetTitle = React.forwardRef<HTMLParagraphElement, SheetTitleProps>(
	({ className, ...props }, ref) => (
